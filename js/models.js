...
export const MODELS = [
  {
    ...
    name: 'Tiny',
    tag: 'le plus léger',
    note: 'Le plus rapide, mais la qualité reste approximative.',
    wasm: { dtype: 'q8', mb: 39 },
  ...
  },
  {
    ...
    name: 'Base',
    tag: 'recommandé',
    note: 'Le meilleur compromis entre vitesse, poids et précision.',
    wasm: { dtype: 'q8', mb: 73 },
  ...
  },
  {
    ...
    name: 'Small',
    tag: 'plus précis',
    note: 'Nettement plus fidèle, pour un temps de calcul un peu plus long.',
  ...
  },
  {
    ...
    name: 'Turbo',
    tag: 'qualité maximale',
    note: 'La meilleure transcription possible. WebGPU vivement conseillé.',
